...
@property (nonatomic,strong)LSPageControl *pageControl;
@end
...
-(void)initialization{
    ...
    _imageHeightPoor = 0;
    self.otherPageControlColor = RGB(193, 193, 193);
...
-(void)setUpUI{
    ...
    self.leftIV.backgroundColor = [UIColor whiteColor];
    ...
    self.centerIV.backgroundColor = [UIColor whiteColor];
    ...
    self.rightIV.backgroundColor = [UIColor whiteColor];
...
-(void)createPageControl{
    ...
    _pageControl = [[LSPageControl alloc]initWithFrame:CGRectMake((self.frame.size.width - 200)/2, ZXMainScrollViewHeight-30, 200, 30)];
    _pageControl.userInteractionEnabled = NO;
    _pageControl.currentPage = 0;
    _pageControl.transform=CGAffineTransformScale(CGAffineTransformIdentity, 1, 1);
//    [_pageControl setValue:[UIImage imageNamed:@""] forKey:@"_pageImage"];
//    [_pageControl setValue:[UIImage imageNamed:@""] forKey:@"_currentPageImage"];
    
    _pageControl.currentPageSize = CGSizeMake(7.0, 7.0);
    _pageControl.pageSize = CGSizeMake(7.0, 7.0);
...
- (void)setInitPageControl:(CGFloat)initPageControl{
    _pageControl.y = ZXMainScrollViewHeight+10;
}
...
-(void)setContentMode:(UIViewContentMode)contentMode
{
    ...
    self.leftIV.contentMode = contentMode;
    self.centerIV.contentMode = contentMode;
    self.rightIV.contentMode = contentMode;
}
...
- (void)setInfoByCurrentImageIndex:(NSUInteger)currentImageIndex {
    ...
    if([self isHttpString:self.data[currentImageIndex]]){
        ...
        self.centerIV.image = [UIImage imageNamed:self.data[currentImageIndex]];
    }
    ...
    if([self isHttpString:self.data[leftIndex]]){
        ...
        self.leftIV.image = [UIImage imageNamed:self.data[leftIndex]];
    }
    ...
    if([self isHttpString:self.data[rightIndex]]){
        ...
        self.rightIV.image = [UIImage imageNamed:self.data[rightIndex]];
    }
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    /** 滚动到某一张图片  (搬砖小弟) **/
    !self.scrollImageBlock ?: self.scrollImageBlock(self.currentImageIndex);
